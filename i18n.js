...
(function () {
  ...
  const strings = {
    de: {
      ...
      tutorial: {
        optionsStep: "Tutorial 1/{{total}}: Oben findest du Optionen für Sprache, Schwierigkeit sowie Musik, Effekte und Touch.",
        step: "Tutorial {{step}}/{{total}}: Route das gezeigte Paket korrekt.",
        helpRef: "Brauchst du Hilfe? Drücke [H].",
        currentPacket: "Aktuelles Paket {{address}}: Drücke [{{key}}]. {{reason}}",
        pressNow: "Drücke jetzt Taste [{{key}}].",
        whyNow: "Warum: {{reason}}",
        firstMistake: "Erster Fehler: Richtige Taste ist {{key}}, weil {{reason}}",
        reasonPrefix: "{{prefix}} ist das spezifischste Präfix.",
        reasonNoRoute: "keine Route 1-4 passt; deshalb Fehlversuch mit Taste 5.",
        reasonSpecial: "dieses Sonderpaket erlaubt nur Taste {{keys}}.",
        achievement: "TUTORIAL ABGESCHLOSSEN",
        skip: "Tutorial überspringen",
        done: "Tutorial abgeschlossen.",
        skipped: "Tutorial übersprungen.",
        requiredSingle: "Tutorial läuft zuerst im Single-Modus."
      },
      ...
      music: { nowPlaying: "Läuft gerade: {{track}}" },
    ...
    en: {
      ...
      tutorial: {
        optionsStep: "Tutorial 1/{{total}}: At the top you can change language, difficulty, and music/effects/touch options.",
        step: "Tutorial {{step}}/{{total}}: Route the shown packet correctly.",
        helpRef: "Need help? Press [H].",
        currentPacket: "Current packet {{address}}: Press [{{key}}]. {{reason}}",
        pressNow: "Press key [{{key}}] now.",
        whyNow: "Why: {{reason}}",
        firstMistake: "First mistake: The correct key is {{key}}, because {{reason}}",
        reasonPrefix: "{{prefix}} is the best match.",
        reasonNoRoute: "no route 1-4 matches; use isolate with key 5.",
        reasonSpecial: "this special packet only allows key {{keys}}.",
        achievement: "TUTORIAL COMPLETED",
        skip: "Skip tutorial",
        done: "Tutorial completed.",
        skipped: "Tutorial skipped.",
        requiredSingle: "Tutorial runs first in single mode."
      },
      ...
      music: { nowPlaying: "Now Playing: {{track}}" },
    ...
    fr: {
      ...
      tutorial: {
        optionsStep: "Tutoriel 1/{{total}} : En haut, tu peux changer la langue, la difficulte et les options musique/effets/touch.",
        step: "Tutoriel {{step}}/{{total}} : Route correctement le paquet affiché.",
        helpRef: "Besoin d'aide ? Appuie sur [A].",
        currentPacket: "Paquet actuel {{address}} : Appuie sur [{{key}}]. {{reason}}",
        pressNow: "Appuie maintenant sur la touche [{{key}}].",
        whyNow: "Pourquoi : {{reason}}",
        firstMistake: "Première erreur : la bonne touche est {{key}}, parce que {{reason}}",
        reasonPrefix: "{{prefix}} est le préfixe le plus spécifique.",
        reasonNoRoute: "aucune route 1-4 ne correspond ; utilise Isoler avec la touche 5.",
        reasonSpecial: "ce paquet spécial n'autorise que la touche {{keys}}.",
        achievement: "TUTORIEL TERMINE",
        skip: "Passer le tutoriel",
        done: "Tutoriel terminé.",
        skipped: "Tutoriel ignoré.",
        requiredSingle: "Le tutoriel se joue d'abord en mode solo."
      },
      ...
      music: { nowPlaying: "En lecture : {{track}}" },
    ...
    es: {
      ...
      tutorial: {
        optionsStep: "Tutorial 1/{{total}}: Arriba puedes cambiar idioma, dificultad y opciones de musica/efectos/tactil.",
        step: "Tutorial {{step}}/{{total}}: Enruta correctamente el paquete mostrado.",
        helpRef: "Necesitas ayuda? Pulsa [A].",
        currentPacket: "Paquete actual {{address}}: Pulsa [{{key}}]. {{reason}}",
        pressNow: "Pulsa ahora la tecla [{{key}}].",
        whyNow: "Por que: {{reason}}",
        firstMistake: "Primer error: La tecla correcta es {{key}}, porque {{reason}}",
        reasonPrefix: "{{prefix}} es el prefijo más específico.",
        reasonNoRoute: "ninguna ruta 1-4 coincide; usa aislar con la tecla 5.",
        reasonSpecial: "este paquete especial solo permite la tecla {{keys}}.",
        achievement: "TUTORIAL COMPLETADO",
        skip: "Saltar tutorial",
        done: "Tutorial completado.",
        skipped: "Tutorial omitido.",
        requiredSingle: "El tutorial se ejecuta primero en modo individual."
      },
