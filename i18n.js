...
(function () {
  ...
  const strings = {
    de: {
      ...
      aria: { music: "Musik umschalten", sound: "Effekte umschalten", touch: "Touch-Buttons umschalten", help: "Spielhilfe anzeigen", lang: "Sprache wählen", helpLink: "Hilfe anzeigen" },
      start: {
      ...
      help: {
        ...
        p5: "Punkte: Korrekte Route +10, korrekter Fehlversuch +5, dazu Kombo-Bonus ab 3 Richtigen in Folge: +10 pro weiterem Kombo-Treffer. Kombo-Stufen: 3 = KOMBO, 5 = KRASSE KOMBO, 10 = GUTER ROUTER, 20 = MONSTER ROUTER.",
        p6: "Level: Das nächste Level kommt alle 100 Punkte; pro Level-Up gibt es +1 Leben.",
      ...
      hud: { score: "Score", lives: "Leben", level: "Level", highscore: "Highscore", correct: "Richtig", wrong: "Falsch", combo: "KOMBO", bonus: "Bonus", nextLevel: "Nächstes Level in {{points}} Punkten ({{progress}}/{{target}})" },
    ...
    en: {
      ...
      aria: { music: "Toggle music", sound: "Toggle effects", touch: "Toggle touch buttons", help: "Show help", lang: "Choose language", helpLink: "Show help" },
      start: {
      ...
      help: {
        ...
        p5: "Points: Correct route +10, correct isolate +5; combo bonus from 3 correct in a row: +10 per further hit. Combo tiers: 3 = COMBO, 5 = MEGA COMBO, 10 = REAL ROUTER, 20 = MONSTER ROUTER.",
        p6: "Level: Next level every 100 points; each level-up gives +1 life.",
      ...
      hud: { score: "Score", lives: "Lives", level: "Level", highscore: "Highscore", correct: "Correct", wrong: "Wrong", combo: "COMBO", bonus: "Bonus", nextLevel: "Next level in {{points}} points ({{progress}}/{{target}})" },
    ...
    fr: {
      ...
      aria: { music: "Activer la musique", sound: "Activer les effets", touch: "Activer les boutons tactiles", help: "Afficher l'aide", lang: "Choisir la langue", helpLink: "Afficher l'aide" },
      start: {
      ...
      help: {
        ...
        p5: "Points : bonne route +10, bon isolement +5 ; combo à partir de 3 : +10. Combos : 3 = COMBO, 5 = MEGA COMBO, 10 = ROI DU ROUTEUR, 20 = MONSTER ROUTER.",
        p6: "Niveau : tous les 100 points, +1 vie.",
      ...
      hud: { score: "Score", lives: "Vies", level: "Niveau", highscore: "Meilleur score", correct: "Juste", wrong: "Faux", combo: "COMBO", bonus: "Bonus", nextLevel: "Prochain niveau dans {{points}} points ({{progress}}/{{target}})" },
    ...
    es: {
      ...
      aria: { music: "Activar música", sound: "Activar efectos", touch: "Activar botones táctiles", help: "Mostrar ayuda", lang: "Elegir idioma", helpLink: "Mostrar ayuda" },
      start: {
      ...
      help: {
        ...
        p5: "Puntos: ruta correcta +10, aislamiento correcto +5; combo desde 3: +10. Combos: 3 = COMBO, 5 = MEGA COMBO, 10 = ROUTER GENIAL, 20 = MONSTER ROUTER.",
        p6: "Nivel: cada 100 puntos, +1 vida.",
      ...
      hud: { score: "Puntos", lives: "Vidas", level: "Nivel", highscore: "Récord", correct: "Bien", wrong: "Mal", combo: "COMBO", bonus: "Bonus", nextLevel: "Siguiente nivel en {{points}} puntos ({{progress}}/{{target}})" },
